...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_korille_voi_ladata_rahaa(self):
    ...
    def test_syo_maukkaasti_ei_vie_saldoa_negatiiseksi(self):
        kortti = Maksukortti(200)
    ...
    def test_kortin_saldo_ei_muutu_negatiivisella_arvolla(self):
        self.kortti.lataa_rahaa(-2000)

        self.assertEqual(str(self.kortti), "Kortilla on rahaa 10.00 euroa")

    def test_syo_edullisesti_onnistuu_tasasummalla(self):
        kortti = Maksukortti(250)
        kortti.syo_edullisesti()

        self.assertEqual(str(kortti), "Kortilla on rahaa 0.00 euroa")

    def test_syo_maukkaasti_onnistuu_tasasummalla(self):
